    ...
    >
      <DialogContent style={{ width: "min(480px, 92vw)" }}>
        <div className="flex flex-col gap-3 p-4">
          ...
          <DialogDescription>
            Optionally seed a known-bad and a known-good commit. You can also
            start empty and mark the current revision good or bad.
          </DialogDescription>
          ...
          <div className="flex justify-end gap-2 pt-1">
            ...
            <Button size="sm" onClick={doStart} disabled={start.isPending}>
