...
function GcDialogBody({ repoId }: { repoId: RepoId }) {
    ...
    const run = () =>
        gc.mutate(
            ...
            {
                onSuccess: () =>
                    toast.success('Repository maintenance complete'),
            },
        );
            ...
            <DialogContent style={{ width: 'min(560px, 92vw)' }}>
                <div className="flex flex-col gap-3 p-4">
                    ...
                    <DialogDescription>
                        ...
                        <span className="font-mono">git gc</span>. Objects are
                        repacked and unreachable ones may be pruned; tracked
                    ...
                    {midOp && (
                        ...
                        >
                            A {inProgress} is in progress. Maintenance is
                            usually safe but discouraged mid-operation —
                            consider finishing or aborting it first.
                        </div>
                    )}
