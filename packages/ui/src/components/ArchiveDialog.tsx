    ...
    >
      <DialogContent style={{ width: "min(520px, 92vw)" }}>
        <div className="flex flex-col gap-3 p-4">
          ...
          <DialogDescription>
            Export a commit, tag, or branch tip as a downloadable archive.
          </DialogDescription>
          ...
          <div className="flex items-center gap-2 text-sm">
            ...
            >
              ...
              >
                <SelectValue>
                  {(value: ArchiveFormat) => FORMAT_LABEL[value] ?? "zip"}
                </SelectValue>
              </SelectTrigger>
              <SelectContent>
          ...
          {exported !== null && (
            ...
            >
              Exported {exported.filename} ({exported.size.toLocaleString()}{" "}
              bytes)
            </div>
          )}
          ...
          <div className="flex justify-end gap-2 pt-1">
            ...
            <Button size="sm" onClick={doExport} disabled={!canExport}>
