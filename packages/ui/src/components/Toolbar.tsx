            ...
            <div className="bg-background flex flex-col border-b pb-1">
                ...
                <div className="flex h-7 justify-start items-center gap-1 px-2">
                    ...
                    >
                        ...
                        <DropdownMenuItem
                            onClick={() => handleFetch({ all: true })}
                        >
                            Fetch all remotes
                        </DropdownMenuItem>
                        <DropdownMenuItem
                            onClick={() => handleFetch({ prune: true })}
                        >
                            Fetch and prune
                        </DropdownMenuItem>
                        <DropdownMenuItem
                            onClick={() =>
                                handleFetch({ all: true, prune: true })
                            }
                        >
                            Fetch all and prune
                        </DropdownMenuItem>
                        <DropdownMenuItem
                            onClick={() => handleFetch({ tags: true })}
                        >
                            Fetch tags
                        </DropdownMenuItem>
                    </SplitButton>
                    ...
                    >
                        ...
                        <DropdownMenuItem
                            onClick={() => handlePush({ setUpstream: true })}
                        >
                            Push and set upstream
                        </DropdownMenuItem>
                        <DropdownMenuItem
                            onClick={() => handlePush({ tags: true })}
                        >
                            Push tags
                        </DropdownMenuItem>
                        <DropdownMenuSeparator />
                ...
                >
                    <AlertDialogContent>
                        <AlertDialogHeader>
                            ...
                            <AlertDialogDescription>
                                The remote has commits you don&apos;t have
                                locally, so the push was rejected. Integrate the
                                remote changes first, then retry the push. A
                                conflicting pull stops here without pushing.
                            </AlertDialogDescription>
                        </AlertDialogHeader>
                        <AlertDialogFooter>
                            <AlertDialogClose
                                onClick={() => setNonFfOpen(false)}
                            >
                                Cancel
                            </AlertDialogClose>
                            <AlertDialogAction
...
function SplitButton({
    ...
    return (
        <div
            className={cn('flex h-5.5 items-stretch', disabled && 'opacity-40')}
        >
            <Tooltip>
                <TooltipTrigger
                    render={
