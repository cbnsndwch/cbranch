...
export function StatusPanel({ repoId }: StatusPanelProps) {
  ...
  if (isLoading) {
    return <p className="text-muted-foreground px-4 py-4 text-xs">Loading…</p>;
  }
    ...
    <div className="flex h-full flex-col overflow-hidden">
      ...
      <div className="flex min-h-0 flex-1 flex-col overflow-hidden">
        <ChangeListToolbar
          ...
          onAction={() => unstageFiles.mutate({ paths: [], all: true })}
        ...
        <div className="min-h-0 overflow-y-auto">
          <StatusChangeList
            ...
            onSelect={(path) => setSelectedDiffFile({ path, staged: true })}
            staged={true}
      ...
      <div className="flex min-h-0 flex-1 flex-col overflow-hidden">
        ...
        <div className="min-h-0 overflow-y-auto">
          <StatusChangeList
            ...
            onSelect={(path) => setSelectedDiffFile({ path, staged: false })}
            staged={false}
