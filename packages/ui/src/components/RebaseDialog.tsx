...
const defaultSquashMessage = (
    ...
    while (
        base > 0 &&
        (rows[base - 1].action === 'fixup' ||
            rows[base - 1].action === 'squash')
    )
        base -= 1;
                    ...
                    <div className="min-h-0 flex-1 overflow-auto border">
                        {!hasBase && (
                            <p className="text-muted-foreground px-3 py-4 text-sm">
                                Choose a base above to list the commits to
                                rebase.
                            </p>
                        )}
                        ...
                        {hasBase && plan.isError && (
                            <p
                                ...
                                role="alert"
                            >
                                Couldn&apos;t compute the rebase range for this
                                base.
                            </p>
                        )}
                        {hasBase &&
                ...
                >
                    <DialogContent style={{ width: 'min(520px, 92vw)' }}>
                        <div className="flex flex-col gap-3 p-4">
                            ...
                            <DialogDescription>
                                Local changes would be overwritten by this
                                rebase. Stash them and rebase, or cancel and
