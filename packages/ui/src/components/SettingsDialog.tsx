                        ...
                        <TabsPanel value="git">
                            {repoId === null ? (
                                <p className="text-muted-foreground py-6 text-sm">
                                    Open a repository to view and edit its git
                                    config.
                                </p>
                            ) : (
        ...
        <div className="flex max-h-[60vh] flex-col gap-4 overflow-auto py-2">
            <div className="flex items-center gap-2 text-sm">
                ...
                <Select
                    value={scope}
                    onValueChange={v =>
                        setScope((v ?? 'global') as WritableScope)
                    }
                >
                    <SelectTrigger
        ...
        <div className="flex flex-col gap-5 py-2">
            ...
            <section className="flex flex-col gap-2">
                ...
                {conflicts.length > 0 && (
                    ...
                    >
                        The chord {conflicts[0]?.chord} is bound to more than
                        one action. Resolve the conflict before it can take
                        effect.
                    </div>
                )}
