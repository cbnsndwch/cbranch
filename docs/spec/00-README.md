...
| 25 | [`25-workspace-intelligence.md`](25-workspace-intelligence.md) | **Workspace Intelligence** — on-demand, host-side architecture analysis for explicit workspace members, with durable artifacts and background-run lifecycle. |
