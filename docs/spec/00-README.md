...
| 21 | [`21-runtime-plugin-system.md`](21-runtime-plugin-system.md) | **Phase 9** — OpenCode-style trusted host extensions: reviewed local ESM modules, explicit publisher trust, declarative contributions, lifecycle audit, and a deferred signed-repository installer. |
