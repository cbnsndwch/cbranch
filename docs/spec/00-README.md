...
| 21 | [`21-runtime-plugin-system.md`](21-runtime-plugin-system.md) | **Phase 9** — Sandboxed host automation from distributed TUF-verified repositories, trusted publishers, private HTTPS/SSH access, permission grants, audit, and constrained security updates. |
...
9. **P9 — Runtime plugins.** Adds sandboxed, permissioned host automation from distributed, signed plugin repositories, including private HTTPS and Git-over-SSH repositories. See `21-runtime-plugin-system.md`.
